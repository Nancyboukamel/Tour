...
public class detailIntroItem implements Serializable {
    ...
    private String chkcreditcardtraffic;

    private String conven;

    private String disablefacility;

    private String foreignerinfocenter;

    private String infocentertraffic;

    private String mainroute;

    private String operationtimetraffic;

    private String parkingtraffic;

    private String restroomtraffic;
    ...
    public String getAccomcountle() {
        return accomcountle;
    }

    public void setAccomcountle(String accomcountle) {
        this.accomcountle = accomcountle;
    }
    ...
    public String getChkcreditcardtraffic() {
        return chkcreditcardtraffic;
    }

    public void setChkcreditcardtraffic(String chkcreditcardtraffic) {
        this.chkcreditcardtraffic = chkcreditcardtraffic;
    }
    ...
    public String getDisablefacility() {
        return disablefacility;
    }

    public void setDisablefacility(String disablefacility) {
        this.disablefacility = disablefacility;
    }

    public String getForeignerinfocenter() {
        return foreignerinfocenter;
    }

    public void setForeignerinfocenter(String foreignerinfocenter) {
        this.foreignerinfocenter = foreignerinfocenter;
    }

    public String getInfocentertraffic() {
        return infocentertraffic;
    }

    public void setInfocentertraffic(String infocentertraffic) {
        this.infocentertraffic = infocentertraffic;
    }
    ...
    public String getOperationtimetraffic() {
        return operationtimetraffic;
    }

    public void setOperationtimetraffic(String operationtimetraffic) {
        this.operationtimetraffic = operationtimetraffic;
    }

    public String getParkingtraffic() {
        return parkingtraffic;
    }

    public void setParkingtraffic(String parkingtraffic) {
        this.parkingtraffic = parkingtraffic;
    }

    public String getRestroomtraffic() {
        return restroomtraffic;
    }

    public void setRestroomtraffic(String restroomtraffic) {
        this.restroomtraffic = restroomtraffic;
    }
    ...
    public String toString() {
        return "detailIntroItem{" +
                ...
                ", smoking='" + smoking + '\'' +
                ", treatmenu='" + treatmenu + '\'' +
                ", chkcreditcardtraffic='" + chkcreditcardtraffic + '\'' +
                ", conven='" + conven + '\'' +
                ", disablefacility='" + disablefacility + '\'' +
                ", foreignerinfocenter='" + foreignerinfocenter + '\'' +
                ", infocentertraffic='" + infocentertraffic + '\'' +
                ", mainroute='" + mainroute + '\'' +
                ", operationtimetraffic='" + operationtimetraffic + '\'' +
                ", parkingtraffic='" + parkingtraffic + '\'' +
                ", restroomtraffic='" + restroomtraffic + '\'' +
                ", shipinfo='" + shipinfo + '\'' +
                '}';
    }
}
