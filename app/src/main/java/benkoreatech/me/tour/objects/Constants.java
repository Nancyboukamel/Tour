...
public class Constants {
    ...
    public static final String sigunguCode="sigunguCode";
    ...
    public static final String get_all_favorites="http://ben.trustworthy.co.kr/k-travel/get_all_favorites.php";
    public static final String post_comment="http://ben.trustworthy.co.kr/k-travel/post_comment.php";
